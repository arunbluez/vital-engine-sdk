...
export class SpatialHashGrid {
   ...
   */
  queryKNearest(position: Vector2, k: number, maxRadius: number = Infinity): EntityId[] {
...
export class QuadTree {
  ...
  constructor(bounds: SpatialPartitionConfig['worldBounds'], maxDepth: number = 5, maxEntitiesPerNode: number = 10) {
...
class QuadTreeNode {
  ...
  insert(entity: SpatialEntity, maxDepth: number, maxEntities: number): boolean {
  ...
  query(query: SpatialQuery, results: EntityId[], allEntities: Map<EntityId, SpatialEntity>): void {
